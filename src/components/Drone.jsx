                  ...
                  >
                    <group name="D_MassPoint" position={[0, 0, 77.5]}>
                      ...
                      >
                        <group
                          name="Drone_Gen_R"
                          position={[-26.78, -31.11, -0.75]}
                          rotation={[Math.PI / 2, -1.03, Math.PI / 2]}
                        >
                          <group
                            name="Drone_Panel_R"
                            position={[0.68, -0.38, 4.96]}
                          >
                            <group
                              name="Drone_leg_R"
                              position={[-12.89, -9.61, -0.73]}
                              rotation={[-1.24, 1.57, 0]}
                            >
                              <group
                                name="R_P1_G"
                                position={[2.42, -4.84, -0.01]}
                                rotation={[-Math.PI, 1.31, Math.PI]}
                              >
                                <group name="R_P2" rotation={[1.33, 0, 0]}>
                                  <group
                                    name="R_P3_G"
                                    position={[0, -22.92, 0.03]}
                                  >
                                    <group
                                      name="R_P4"
                                      position={[0, 0, 0]}
                                    ...
                                    >
                                      <group
                                        name="R_P5_M"
                                        position={[0.01, -11.29, 0.08]}
                                      >
                                        <group
                                          name="R_P6_G"
                                          position={[-0.01, -9.33, -0.08]}
                                        >
                                          <group
                                            name="R_P7"
                                            rotation={[1.41, 0, 0]}
                              ...
                              >
                                <group name="L_P2" rotation={[1.28, 0, 0]}>
                                  ...
                                  >
                                    <group
                                      name="L_P4"
                                      rotation={[1.46, 0, -Math.PI]}
                                    >
                                      <group
                                        name="L_P5_M"
                                        position={[0.06, -11.24, 0.08]}
                                        rotation={[0, 0, -0.02]}
                                      >
                                        <group
                                          name="L_P6_G"
                                          position={[0.14, -9.37, -0.08]}
                                        >
                                          <group
                                            name="L_P7"
                                            position={[0.01, 0, 0]}
                        ...
                        <group
                          name="Drone_Turb_M_L"
                          position={[19.97, 24.56, -6.01]}
                          rotation={[-1.68, -0.24, 1.57]}
                        >
                          <group
                            name="Drone_Turb_Blade_L"
                            position={[0, -36.16, -10.97]}
                            rotation={[-1.28, 1.07, Math.PI]}
                          >
                            <mesh
                          ...
                          >
                            ...
                            >
                              <group name="F_P3_G" position={[0, -22.92, 0.03]}>
                                <group
                                  name="F_P4"
                                  rotation={[1.22, 0, Math.PI]}
                                >
                                  <group
                                    name="F_P5_M"
                                    position={[-0.02, -11.28, 0.08]}
                                  >
                                    <group
                                      name="F_P6_G"
                                      position={[0.01, -9.33, -0.08]}
                        ...
                        <group name="Drone_ILens" position={[0, -14.97, 41.51]}>
                          <group
                            name="Drone_IEye"
                            position={[0, -0.02, -8.91]}
                            rotation={[3.12, 0.12, -3.14]}
                          >
                            <mesh
                              name="1"
