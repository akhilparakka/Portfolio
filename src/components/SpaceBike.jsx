...
export default function SpaceBike(props) {
  const group = useRef();
  const { nodes, materials, animations } = useGLTF(
    "/spaceBike-transformed.glb"
  );
  const { actions } = useAnimations(animations, group);
  return (
    <group ref={group} {...props} dispose={null} scale={[0.003, 0.003, 0.003]}>
...
useGLTF.preload("/spaceBike-transformed.glb");
